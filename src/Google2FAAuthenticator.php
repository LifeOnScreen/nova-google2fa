...
class Google2FAAuthenticator extends Authenticator
{
    ...
    protected function google2FAValidUntillNow()
    {
        ...
        $user2faValidUntill = is_object($this->getUser()->user2fa) && !empty($this->getUser()->user2fa->updated_at) ? Carbon::parse($this->getUser()->user2fa->updated_at->timestamp)->addSeconds($user2faTimeout) : null;
